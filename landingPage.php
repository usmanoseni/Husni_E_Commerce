    ...
    <nav class="bg-white/90 w-full h-14 fixed z-10 flex items-center justify-between px-10  top-0">
       <div class="flex items-center ">
        ...
        <div class="flex  gap-4">
                <button class="hidden md:block bg-blue-400 text-sm px-5 py-1 rounded-lg hover:transition-transform hover:duration-200 hover:bg-blue-500 active:bg-blue-600  cursor-pointer text-white "><a href="#">Log in</a></button>
