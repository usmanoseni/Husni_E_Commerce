...
<head>
    ...
    <title> www.husni_e-commerce/login_page.com</title>
...
<body class="bg-slate-50 font-[roboto] flex items-center justify-center place-items-center h-[100vh] ">
    ...
    <div class="relative flex top-0 left-0 bg-white/90 w-[335px] z-20 rounded-2xl shadow-2xl flex-col gap-3 py-6 px-3">
        <form action="#" method="get">
            <div class="flex justify-center gap-1 align-middle items-center text-xl font-bold text-center">Login <span class="text-violet-600 text-3xl ">!</span></div>
            ...
            <div class="flex flex-col mt-6  gap-3.5">
                ...
                <div class="relative h-10 w-full">
                    <input type="password" id="password" name="password" placeholder=" " autocomplete="off" required class="peer relative h-full w-full border border-gray-400 bg-transparent px-3 pt-4 pb-1.5 text-sm font-semibold text-gray-600 placeholder-transparent focus:border-blue-500 focus:outline-none outline-none transition-all duration-200 rounded-md" />
                   ...
                   <div id="invisible" class=" absolute right-3 top-3" onclick="login_passwordfn()" >
            ...
            <div class="text-sm mt-2.5 ml-3 text-gray-600 font-semibold">Create an account ? <span class="hover:text-blue-400  transition-all duration-200 text-fuchsia-700 focus:text-blue-400 active:text-blue-400 "><a href="../login/sign_up.php">Sign up</a></span></div>
